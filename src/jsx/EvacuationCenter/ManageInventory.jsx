        ...
        const fetchStockRequests = async () => {
            try {
                const response = await fetch(
                    `http://localhost:3000/stock-request/center/${evacuationCenterId}`,
                    {
                        method: "GET",
                        headers: {
                            "Content-Type": "application/json",
            ...
            <div className='page-content-manage-requests'>
                ...
                <div className='dashboard-mini-root'>
                    ...
                    <div className="dashboard-mini-card">
                        ...
                        <p>{stocks?.stocks?.HygienePack ?? 0}</p>
                    </div>
                    ...
                    <div className="dashboard-mini-card">
                        ...
                        <p>{stocks?.stocks.MedicinePack ?? 0}</p>
                    </div>
                    ...
                    <div className="dashboard-mini-card">
                        ...
                        <p>{stocks?.stocks?.ClothingPack ?? 0}</p>
                    </div>
                    ...
                    <div className="dashboard-mini-card">
                        ...
                        <p>{stocks?.stocks?.InfantPack ?? 0}</p>
                    </div>
                </div>

                <br />
                <h2>Inventory Request History</h2>
